...
namespace FullstackMVC.Migrations
{
    ...
    [Migration("20211012140350_addExperienceAndLeveltOMonsterAndCharacterModel")]
    partial class addExperienceAndLeveltOMonsterAndCharacterModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FullstackMVC.Models.BattleViewModel", b =>
                {
                    ...
                    b.Property<int>("DropIndex")
                        .HasColumnType("int");

                    b.Property<int>("GoldenCoins")
                        .HasColumnType("int");

                    b.Property<string>("ImageMonster")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FullstackMVC.Models.FightStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("BattleViewModelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BattleViewModelId");

                    b.ToTable("FightStatus");
                });
            ...
            modelBuilder.Entity("FullstackMVC.Models.FightStatus", b =>
                {
                    b.HasOne("FullstackMVC.Models.BattleViewModel", null)
                        .WithMany("FightStatus")
                        .HasForeignKey("BattleViewModelId");
                });
