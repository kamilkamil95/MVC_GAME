...
namespace FullstackMVC.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        {
            if(!await _roleManager.RoleExistsAsync(Consts.AdminRole))
            {
                await _roleManager.CreateAsync(new IdentityRole(Consts.AdminRole));
                await _roleManager.CreateAsync(new IdentityRole(Consts.UserRole));
            }
